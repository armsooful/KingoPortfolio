...
친절하고 전문적이되 지나치게 격식적이지 않은 톤으로 작성해주세요."""
    ...
    def _get_fallback_response(self, investment_type: str) -> Dict[str, str]:
        ...
        fallback_responses = {
            "conservative": {
                "personalized_analysis": "변동성이 낮은 자산 증식을 선호하시는 보수형 투자자십니다. 원금 보존을 최우선으로 하며, 예측 가능한 수익을 추구하는 성향이 강합니다.",
                "investment_advice": "채권형 펀드, 예적금, CMA 등 변동성이 낮은 상품 위주로 포트폴리오를 구성하시는 것을 권장합니다. 주식은 20% 이하로 제한하고, 배당주나 인덱스 펀드를 고려하세요.",
            ...
            "aggressive": {
                ...
                "risk_warning": "높은 수익 추구는 높은 손실 위험을 동반합니다. 레버리지 상품은 신중하게 접근하고, 전체 자산의 일정 부분은 변동성이 낮은 자산으로 보유하세요."
            }
        }
