"""
포트폴리오 시뮬레이션 API 엔드포인트 (교육용)

⚠️ 본 API는 투자 전략 학습을 위한 시뮬레이션 기능을 제공합니다.
...
async def generate_portfolio(
    ...
    ⚠️ 본 엔드포인트는 투자 전략 학습을 위한 시뮬레이션 결과를 제공합니다.
    결과는 투자 권유·자문 서비스가 아닙니다.

    진단 ID를 제공하면 해당 진단 결과의 전략 유형을 사용합니다.
