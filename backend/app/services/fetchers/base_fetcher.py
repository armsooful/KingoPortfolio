...
class DataType(str, Enum):
    ...
    # Level 2: 예금/적금/연금저축/대출 상품
    DEPOSIT_PRODUCT = "DEPOSIT_PRODUCT"
    SAVINGS_PRODUCT = "SAVINGS_PRODUCT"
    ANNUITY_SAVINGS_PRODUCT = "ANNUITY_SAVINGS_PRODUCT"
    MORTGAGE_LOAN_PRODUCT = "MORTGAGE_LOAN_PRODUCT"
    RENT_HOUSE_LOAN_PRODUCT = "RENT_HOUSE_LOAN_PRODUCT"
    CREDIT_LOAN_PRODUCT = "CREDIT_LOAN_PRODUCT"
